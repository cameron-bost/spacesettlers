...
public class AStarSearch  {
	...
	private static final double maxNodeDistance = 300;
	 ...
	 * 
	 */
	public static Graph createFixedGraphToGoalWithBeacons(Toroidal2DPhysics state, Ship myShip, 
			Position goalPosition, List<Position> waypoints, int maxDistance) {
		// where am I?
		Position startPos = myShip.getPosition();
		...
		for (Position waypoint : waypoints) {
			graph.addVertex(new Vertex(waypoint));
		}
