 ...
 * @author amy
 */
public class BDSMMoveAction extends AbstractAction {
	/**
...
//		float Kp = 0.16f;
	...
	public Vector2D pdControlMoveToGoalFixSlow(Toroidal2DPhysics space, Position goalLoc,
